 ...
 *
 * File management interface for clients to upload, organize,
 * and manage their project files and documents.
 */
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Manage your project files, documents, and drawings. Upload CAD files (DWG, DXF),
